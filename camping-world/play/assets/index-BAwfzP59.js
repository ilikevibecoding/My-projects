...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ss(e,t,n){let r=new Float32Array(cs),i=new K(0,1,0);return new Sa({name:`SphericalGaussianBlur`,defines:{n:cs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ts(),fragmentShader:`
	...
	`}var Es=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=fr.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=fr.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=fr.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=fr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case g:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=g;break;case _:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=_;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case g:case _:e.colorSpace=ze,e.minFilter=s,e.magFilter=s,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Fd={kloppenheim_02_puresky:{azimuthDeg:54.4,elevationDeg:17.1,sunColor:16767400,sunIntensity:18,envIntensity:1.15,backgroundIntensity:1,fogColor:14205856,fogDensity:.0045},belfast_sunset_puresky:{azimuthDeg:45.1,elevationDeg:6.5,sunColor:16758903,sunIntensity:16,envIntensity:1,backgroundIntensity:1,fogColor:13150595,fogDensity:.005},autumn_field_puresky:{azimuthDeg:53.8,elevationDeg:29.1,sunColor:16769200,sunIntensity:16,envIntensity:1.5,backgroundIntensity:1,fogColor:12234383,fogDensity:.0044}},Id=`autumn_field_puresky`,Ld=53.8;async function Rd(e,t,n=Id){let r={...Fd[n]??Fd.autumn_field_puresky},i=new URLSearchParams(location.search);i.get(`sunel`)&&(r.elevationDeg=parseFloat(i.get(`sunel`))),i.get(`sunaz`)&&(r.azimuthDeg=parseFloat(i.get(`sunaz`))),i.get(`sunint`)&&(r.sunIntensity=parseFloat(i.get(`sunint`))),i.get(`env`)&&(r.envIntensity=parseFloat(i.get(`env`))),i.get(`fog`)&&(r.fogDensity=parseFloat(i.get(`fog`)));let a=await new Pd().loadAsync(`./assets/env/${n}_4k.hdr`);a.mapping=303;{let e=a.image.data;if(e instanceof Uint16Array){let t=20480;for(let n=0;n<e.length;n++)(e[n]&32767)>t&&!(e[n]&32768)&&(e[n]=t)}else for(let t=0;t<e.length;t++)e[t]>32&&(e[t]=32);a.generateMipmaps=!0,a.minFilter=l,a.magFilter=s,a.needsUpdate=!0}let o=new _s(t);e.environment=o.fromEquirectangular(a).texture,e.environmentIntensity=r.envIntensity,e.background=a,e.backgroundIntensity=r.backgroundIntensity,o.dispose();let c=Et.degToRad(r.azimuthDeg),u=Et.degToRad(r.elevationDeg),d=new K(Math.cos(u)*Math.sin(c),Math.sin(u),Math.cos(u)*Math.cos(c)),f=new To(r.sunColor,r.sunIntensity);return f.position.copy(d).multiplyScalar(220),f.castShadow=!0,f.shadow.mapSize.set(4096,4096),f.shadow.camera.left=-55,f.shadow.camera.right=55,f.shadow.camera.top=55,f.shadow.camera.bottom=-55,f.shadow.camera.near=60,f.shadow.camera.far=420,f.shadow.camera.updateProjectionMatrix(),f.shadow.bias=-2e-4,f.shadow.normalBias=.15,f.shadow.radius=1.5,e.add(f),e.add(f.target),e.fog=new jn(r.fogColor,r.fogDensity),{sun:f,sunDir:d,preset:r}}var zd={value:0};function Bd(e){zd.value=e}function Vd(e){if(!e)return;let t=e.transparent||e.alphaTest>0;t&&(e.transparent=!1,e.alphaTest=.45,e.depthWrite=!0,e.side=2,e.roughness=Math.max(e.roughness??1,.85),e.envMapIntensity=.55),t&&(e.onBeforeCompile=e=>{e.uniforms.uTime=zd,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
           ...
           }`)})}function Hd(e,{shadows:t=!0}={}){return e.traverse(e=>{e.isMesh&&(e.castShadow=t,e.receiveShadow=!0,(Array.isArray(e.material)?e.material:[e.material]).forEach(Vd))}),e}var Ud={island_tree_01:{scale:[1.5,1.9],trunk:.5,sink:.22},island_tree_02:{scale:[1.5,2],trunk:.4,sink:.2},tree_small_02:{scale:[1.6,2.4],trunk:.3,sink:.18},searsia_lucida:{scale:[1,1.4],trunk:.3,sink:.18},fir_sapling:{scale:[1.2,1.8],trunk:.15,sink:.12}},Wd={};for(let[e,t]of Object.entries(Ud))Wd[e]=t,Wd[`${e}_hero`]=t,Wd[`${e}_mid`]=t,Wd[`${e}_far`]=t;var Gd=Ld*Math.PI/180;function Kd(e,t,n=.38){let r=Math.abs(Math.atan2(e,t)-Gd);return r>Math.PI&&(r=Math.PI*2-r),r<n}function qd(e,t,n){for(let[e,n]of Object.entries(t))!e.startsWith(`searsia_lucida`)&&!e.startsWith(`nettle_plant`)||n.scene.traverse(e=>{e.isMesh&&e.material?.color&&!e.material.userData.warmTinted&&(e.material.color.multiply(new X(1.08,1,.72)),e.material.userData.warmTinted=!0)});let r=Sd(4242),i=[],a=[],o=new Cn;o.name=`vegetation`;function s(e,t,n,i=40){for(let o=0;o<i;o++){let i=r()*Math.PI*2,o=e+(t-e)*Math.sqrt(r()),s=Math.cos(i)*o,c=Math.sin(i)*o;if(a.every(e=>Math.hypot(e.x-s,e.z-c)>n+e.r))return{x:s,z:c}}return null}function c(e,s,c,{shadows:l=!0,scaleMul:u=1}={}){let d=Wd[e],f=t[e];if(!f)return;let p=f.scene.clone(!0),m=(d.scale[0]+r()*(d.scale[1]-d.scale[0]))*u;return p.scale.setScalar(m),p.rotation.y=r()*Math.PI*2,p.position.set(s,n(s,c)-d.sink*m,c),Hd(p,{shadows:l}),o.add(p),a.push({x:s,z:c,r:2.5*m}),i.push({x:s,z:c,radius:d.trunk*m}),p}c(`island_tree_01_hero`,-8.5,-6.5),c(`tree_small_02_hero`,10.5,-11),c(`searsia_lucida`,-13,12);let l=[`tree_small_02`,`searsia_lucida`,`island_tree_02`,`fir_sapling`];for(let e=0;e<7;e++){let e=s(20,36,11);e&&c(l[Math.floor(r()*l.length)],e.x,e.z)}let u=[`island_tree_01_mid`,`island_tree_02_mid`,`tree_small_02_mid`,`tree_small_02_mid`,`searsia_lucida_mid`,`fir_sapling_mid`];for(let e=0;e<42;e++){let e=s(38,62,6.5);e&&(Kd(e.x,e.z)&&r()<.7||c(u[Math.floor(r()*u.length)],e.x,e.z))}let d=[`island_tree_02_far`,`tree_small_02_far`],f=[];for(let e=0;e<240;e++){let t=e/240*Math.PI*2+r()*.05,n=e%3,i=n===0?64+r()*14:n===1?80+r()*18:100+r()*30;i<80&&Kd(Math.cos(t)*i,Math.sin(t)*i,.2)&&r()<.55||f.push({a:t,r:i,type:d[Math.floor(r()*d.length)],s:n===2?3+r()*1.8:2.4+r()*1.5,rot:r()*Math.PI*2})}for(let e of d){let r=f.filter(t=>t.type===e),i=t[e];!i||r.length===0||(i.scene.updateMatrixWorld(!0),i.scene.traverse(e=>{if(!e.isMesh)return;let t=new ki(e.geometry,e.material,r.length);t.castShadow=!1,t.receiveShadow=!1;let i=new Y,a=new Y;r.forEach((r,o)=>{let s=Math.cos(r.a)*r.r,c=Math.sin(r.a)*r.r;a.compose(new K(s,n(s,c)-.3*r.s,c),new Dt().setFromAxisAngle(new K(0,1,0),r.rot),new K(r.s,r.s,r.s)),i.multiplyMatrices(a,e.matrixWorld),t.setMatrixAt(o,i)}),t.instanceMatrix.needsUpdate=!0,(Array.isArray(t.material)?t.material:[t.material]).forEach(Vd),o.add(t)}))}for(let e of[{id:`shrub_02`,count:30,minR:18,maxR:58,scale:[.8,1.4],sink:.06},{id:`shrub_03`,count:24,minR:16,maxR:58,scale:[.8,1.5],sink:.06},{id:`fern_02`,count:30,minR:12,maxR:50,scale:[.9,1.6],sink:.04},{id:`nettle_plant`,count:12,minR:14,maxR:45,scale:[.7,1.1],sink:.04},{id:`dandelion_01`,count:36,minR:4,maxR:30,scale:[.6,1],sink:.03},{id:`shrub_01`,count:12,minR:26,maxR:60,scale:[.9,1.5],sink:.08}]){let i=t[e.id];if(!i)continue;i.scene.updateMatrixWorld(!0);let a=[];for(let t=0;t<e.count;t++){let t=r()*Math.PI*2,n=e.minR+(e.maxR-e.minR)*Math.sqrt(r());a.push({x:Math.cos(t)*n,z:Math.sin(t)*n,s:e.scale[0]+r()*(e.scale[1]-e.scale[0]),rot:r()*Math.PI*2})}i.scene.traverse(t=>{if(!t.isMesh)return;let r=new ki(t.geometry,t.material,a.length);r.castShadow=!0,r.receiveShadow=!0;let i=new Y,s=new Y;a.forEach((a,o)=>{s.compose(new K(a.x,n(a.x,a.z)-e.sink*a.s,a.z),new Dt().setFromAxisAngle(new K(0,1,0),a.rot),new K(a.s,a.s,a.s)),i.multiplyMatrices(s,t.matrixWorld),r.setMatrixAt(o,i)}),r.instanceMatrix.needsUpdate=!0,(Array.isArray(r.material)?r.material:[r.material]).forEach(Vd),o.add(r)})}return e.add(o),{group:o,colliders:i}}var Jd={cols:4,rows:2,cells:[{cell:0,heightM:.147,frameM:.342},{cell:1,heightM:.169,frameM:.307},{cell:2,heightM:.218,frameM:.235},{cell:3,heightM:.142,frameM:.301},{cell:4,heightM:.323,frameM:.348},{cell:5,heightM:.178,frameM:.203},{cell:6,heightM:.403,frameM:.435},{cell:7,heightM:.26,frameM:.343}]},Yd=4,Xd=2,Zd=[.26,.24,.015,.24,.015,.015,.105,.11],Qd=95,$d=13e4;function ef(e){let t=e();for(let e=0;e<Zd.length;e++)if(t-=Zd[e],t<=0)return e;return 0}function tf(){let e=[];for(let t of[0,Math.PI/2]){let n=new fa(1,1,2,2);n.translate(0,.5,0),n.rotateY(t),e.push(n)}let t=new jr,n=[],r=[],i=[],a=0;for(let t of e){let e=t.attributes.position.array,o=t.attributes.uv.array;n.push(...e),r.push(...o);let s=t.index.array;for(let e of s)i.push(e+a);a+=t.attributes.position.count}return t.setAttribute(`position`,new yr(n,3)),t.setAttribute(`uv`,new yr(r,2)),t.setAttribute(`normal`,new yr(Array.from({length:n.length/3},()=>[0,1,0]).flat(),3)),t.setIndex(i),t}var nf={value:0};function rf(e){nf.value=e}function af(e,t,r){let i=parseFloat(new URLSearchParams(location.search).get(`grassboost`)??`1`),a=Sd(90210),o=Td(555,3),s=new io().load(`./assets/textures/grass/grass_atlas.png`);s.colorSpace=Re,s.anisotropy=8,s.wrapS=s.wrapT=n;let c=tf(),l=new wa({map:s,alphaTest:.12,alphaToCoverage:!0,side:2,roughness:.92,metalness:0});l.onBeforeCompile=e=>{e.uniforms.uTime=nf,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
         uniform float uTime;
         ...
         vCellUv = uv;`),e.vertexShader=e.vertexShader.replace(`#include <uv_vertex>`,`#include <uv_vertex>
       {
         float cellX = mod(aCell, ${Yd}.0);
         float cellY = floor(aCell / ${Yd}.0);
         #ifdef USE_MAP
           vMapUv = (uv + vec2(cellX, ${Xd}.0 - 1.0 - cellY)) / vec2(${Yd}.0, ${Xd}.0);
         #endif
       }`),e.fragmentShader=e.fragmentShader.replace(`#include <normal_fragment_begin>`,`#include <normal_fragment_begin>
       normal = normalize( vNormal );
       nonPerturbedNormal = normal;`),e.fragmentShader=e.fragmentShader.replace(`#include <aomap_fragment>`,`#include <aomap_fragment>
       ...
       reflectedLight.directSpecular *= 0.15;`)};let u=new ki(c,l,$d);u.receiveShadow=!0,u.castShadow=!1,u.name=`grass`;let d=new Float32Array($d),f=new Y,p=new Dt,m=new K(0,1,0),h=new X,g=0,_=0;for(;g<$d&&_<$d*8;){_++;let e=a()*Math.PI*2,n=Math.sqrt(a())*Qd,s=Math.cos(e)*n,c=Math.sin(e)*n,l=Math.hypot(s-r.x,c-r.y);if(l<2)continue;let v=.8+o(s*.03,c*.03)*.2;if(n>55&&(v*=Et.mapLinear(n,55,Qd,1,.42)),l<6&&(v*=Et.mapLinear(l,2,6,.45,1)),a()>v)continue;let y=g++,b=ef(a);d[y]=b;let x=Jd.cells[b]?.frameM??.35,S=1+.35*Et.smoothstep(n,55,Qd),C=x*(.85+a()*.55)*1.6*S,w=C*(.9+a()*.25),T=C*(.8+a()*.4),E=t(s,c);p.setFromAxisAngle(m,a()*Math.PI*2),f.compose(new K(s,E-.015,c),p,new K(w,T,w)),u.setMatrixAt(y,f);let D=1-.15*Et.smoothstep(n,40,Qd),O=(.92+a()*.44)*2*D*i,ee=a();h.setRGB(O*(.78+ee*.34),O*(.9+(1-ee)*.16),O*(.52+(1-ee)*.22)),u.setColorAt(y,h)}return u.count=g,c.setAttribute(`aCell`,new xi(d,1)),u.instanceMatrix.needsUpdate=!0,u.instanceColor&&(u.instanceColor.needsUpdate=!0),e.add(u),{mesh:u,count:g}}function of(e,t){let n=e[t];if(!n)return console.warn(`[campsite] model "${t}" missing — prop skipped`),null;let r=n.scene.clone(!0);return Hd(r),r}function sf(e,t){let n=e[t];if(!n)return[];n.scene.updateMatrixWorld(!0);let r=[];return n.scene.traverse(e=>{e.isMesh&&r.push(e)}),r}function cf(e,t,n,r){e.updateMatrixWorld(!0);let i=new qn().setFromObject(e),a=i.getCenter(new K);e.position.x+=t-a.x,e.position.z+=r-a.z,e.position.y+=n-i.min.y}function lf(e,t,n){let r=Sd(777),i=new Cn;i.name=`campsite`;let a=[],o=new G(1.5,1),s=(e,t)=>n(e,t),c=of(t,`stone_fire_pit`);if(c){let e=new qn().setFromObject(c),t=1.9/(e.getSize(new K).x||1);c.scale.setScalar(t),c.rotation.y=r()*Math.PI*2,c.position.set(o.x,s(o.x,o.y)-e.min.y*t-.13,o.y),c.traverse(e=>{e.isMesh&&e.material&&(e.material.roughness=Math.max(e.material.roughness??1,.9),e.material.envMapIntensity=1.5,e.material.color=new X(14405049))}),i.add(c)}{let e=new pa(.46,28,10,0,Math.PI*2,0,Math.PI/2),t=e.attributes.position,n=new Float32Array(t.count*3);for(let e=0;e<t.count;e++){let i=t.getX(e),a=t.getY(e),o=t.getZ(e),s=Math.hypot(i,o),c=1+(r()-.5)*.2;t.setX(e,i*c),t.setZ(e,o*c),t.setY(e,a*.2+(r()-.5)*.055*(1-s/.55));let l=.55+r()*.75;n[e*3]=l,n[e*3+1]=l,n[e*3+2]=l*(.92+r()*.1)}e.setAttribute(`color`,new gr(n,3)),e.computeVertexNormals();let a=new ri(e,new wa({color:4867648,roughness:1,envMapIntensity:.2,vertexColors:!0}));a.position.set(o.x,s(o.x,o.y)+.045,o.y),a.receiveShadow=!0,a.castShadow=!0,i.add(a);let c=new da(1,0),l=new wa({color:2038809,roughness:.78,envMapIntensity:.5});for(let e=0;e<9;e++){let e=r()*Math.PI*2,t=r()*.3,n=.025+r()*.045,a=new ri(c,l);a.scale.set(n*(.7+r()*.8),n*.6,n*(.7+r()*.8)),a.rotation.set(r()*Math.PI,r()*Math.PI,r()*Math.PI),a.position.set(o.x+Math.cos(e)*t,s(o.x,o.y)+.1-t*.12,o.y+Math.sin(e)*t),a.castShadow=a.receiveShadow=!0,i.add(a)}}let l=sf(t,`dead_tree_trunk_02`),u=(e,t=null)=>{if(!l.length)return null;let n=l[0],r=t?Object.assign(n.material.clone(),{color:new X(t),roughness:1}):n.material,i=new ri(n.geometry,r);i.castShadow=i.receiveShadow=!0;let a=new qn().setFromObject(new ri(n.geometry)),o=e/Math.max(a.getSize(new K).x,.01);return i.scale.setScalar(o),i.userData.box=a,i.userData.s=o,i},d=(e,t,n,r=0)=>{let{box:a,s:o}=e.userData;e.position.set(t,s(t,n)-a.min.y*o-.03+r,n),i.add(e)},f=u(.7,5589566);f&&(f.rotation.set(.04,.5,0),d(f,o.x-.05,o.y+.08));let p=u(.58,6049602);p&&(p.rotation.set(-.04,2.1,.08),d(p,o.x+.14,o.y-.12,.04));{let e=o.x+2.15,n=o.y+.35;for(let t of[{dx:0,dz:0,yaw:.4,roll:0,len:.8,lift:0},{dx:.1,dz:.32,yaw:.62,roll:.12,len:.74,lift:0},{dx:-.12,dz:-.3,yaw:.25,roll:-.08,len:.7,lift:0},{dx:.02,dz:.16,yaw:1.35,roll:.16,len:.72,lift:.14},{dx:-.05,dz:-.1,yaw:-.5,roll:-.14,len:.66,lift:.2},{dx:-1,dz:-.7,yaw:1.9,roll:0,len:.62,lift:0},{dx:-1.7,dz:-1.15,yaw:.9,roll:0,len:.55,lift:0}]){let i=u(t.len);if(!i)break;i.rotation.set((r()-.5)*.08,t.yaw,t.roll),d(i,e+t.dx,n+t.dz,t.lift)}let a=sf(t,`bark_debris_01`);if(a.length){let t=a[0].material.clone();t.color=new X(10521716),t.roughness=1;for(let o=0;o<4;o++){let c=a[o%a.length],l=new ri(c.geometry,t);l.castShadow=l.receiveShadow=!0;let u=new qn().setFromObject(new ri(c.geometry)),d=(.35+r()*.2)/Math.max(u.getSize(new K).x,.01);l.scale.setScalar(d),l.rotation.set(0,r()*Math.PI*2,0);let f=r()*Math.PI*2,p=.7+r()*.9,m=e+Math.cos(f)*p,h=n+Math.sin(f)*p;l.position.set(m,s(m,h)-u.min.y*d-.02,h),i.add(l)}}}let m=of(t,`dry_branches_medium_01`);m&&(m.scale.setScalar(.9),m.rotation.y=2.1,m.position.set(o.x-2.4,s(o.x-2.4,o.y+2.1)-.02,o.y+2.1),i.add(m));let h=of(t,`dead_tree_trunk`);if(h){let e=o.x-.4,t=o.y+2.3;h.rotation.y=-.35,h.position.set(e,s(e,t)+.02,t),i.add(h),a.push({x:e,z:t,radius:.45})}let g=of(t,`dead_tree_trunk_02`);if(g){let e=o.x+6.5,t=o.y-4.5;g.rotation.y=1.9,g.position.set(e,s(e,t)+.02,t),i.add(g),a.push({x:e,z:t,radius:.4})}let _=of(t,`tree_stump_01`);if(_){let e=o.x+2.9,n=o.y-1.6;_.position.set(e,s(e,n)-.03,n),_.rotation.y=r()*Math.PI,i.add(_),a.push({x:e,z:n,radius:.4});let c=of(t,`hatchet`);if(c){let t=new qn().setFromObject(_);c.rotation.set(.04,1.2,Math.PI/2-.12),i.add(c),cf(c,e+.05,t.max.y+.01,n-.05)}}let v=of(t,`wooden_crate_01`);if(v){let e=o.x-2.9,n=o.y+1.6;v.rotation.y=.5,v.position.set(e,s(e,n)-.01,n),i.add(v),a.push({x:e,z:n,radius:.42});let r=of(t,`wooden_lantern_01`);if(r){let e=new qn().setFromObject(v),t=e.getCenter(new K);r.rotation.y=-.4,i.add(r),cf(r,t.x,e.max.y+.002,t.z)}}for(let e of[{id:`boulder_01`,x:-6,z:8.5,s:.85,sink:.25},{id:`rock_moss_set_01`,x:8.5,z:6.5,s:1,sink:.12},{id:`namaqualand_boulder_02`,x:-4.5,z:-7.5,s:.8,sink:.2},{id:`rock_07`,x:5,z:9.5,s:1.1,sink:.1}]){let n=of(t,e.id);n&&(n.scale.setScalar(e.s),n.rotation.y=r()*Math.PI*2,n.position.set(e.x,s(e.x,e.z)-e.sink,e.z),i.add(n),a.push({x:e.x,z:e.z,radius:.9*e.s}))}let y=of(t,`bark_debris_01`);return y&&(y.rotation.y=4.2,y.scale.setScalar(.8),y.position.set(-12,s(-12,16)-.04,16),i.add(y)),e.add(i),{group:i,colliders:a,campCenter:o}}var uf=`island_tree_01.island_tree_02.tree_small_02.searsia_lucida.fir_sapling.island_tree_01_hero.tree_small_02_hero.island_tree_01_mid.island_tree_02_mid.tree_small_02_mid.searsia_lucida_mid.fir_sapling_mid.island_tree_02_far.tree_small_02_far.shrub_01.shrub_02.shrub_03.fern_02.nettle_plant.dandelion_01.stone_fire_pit.dead_tree_trunk.dead_tree_trunk_02.tree_stump_01.dry_branches_medium_01.bark_debris_01.sand_rocks_small_01.rock_07.boulder_01.rock_moss_set_01.namaqualand_boulder_02.hatchet.wooden_crate_01.wooden_lantern_01`.split(`.`);async function df(e,t,n=()=>{}){let r=Rd(e,t,new URLSearchParams(location.search).get(`hdri`)??`autumn_field_puresky`);Nd(e);let i=new Su;i.setMeshoptDecoder(xd);let a=0,o={};await Promise.all(uf.map(async e=>{for(let t=0;t<3;t++)try{o[e]=await i.loadAsync(`./assets/models/${e}.glb`);break}catch(n){t===2?console.error(`[world] failed to load model ${e}:`,n.message??n):await new Promise(e=>setTimeout(e,800*(t+1)))}n(++a/(uf.length+1))}));let s=await r;n(1);let c=lf(e,o,jd),l=qd(e,o,jd),u=af(e,jd,c.campCenter);return console.log(`[world] grass instances: ${u.count}`),{getTerrainHeight:jd,colliders:[...l.colliders,...c.colliders],sky:s,update(e){rf(e),Bd(e)}}}var ff={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},pf=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},mf=new Co(-1,1,1,-1,0,1),hf=new class extends jr{constructor(){super(),this.setAttribute(`position`,new yr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new yr([0,2,0,0,2,0],2))}},gf=class{constructor(e){this._mesh=new ri(hf,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,mf)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},_f=class extends pf{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Sa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ya.clone(e.uniforms),this.material=new Sa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new gf(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},vf=class extends pf{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},yf=class extends pf{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},bf=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Kt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new _f(ff),this.copyPass.material.blending=0,this.timer=new No}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}vf!==void 0&&(r instanceof vf?n=!0:r instanceof yf&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},xf=class extends pf{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new X}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Sf={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Tf={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new G(1/1024,1/512)}},vertexShader:`
		...
		}`},Ef={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new G(1/1024,1/512)}},vertexShader:`
...
void main() {
   ...
   vec3 getWorldPosLog(vec3 posS) {
    ...
    `},Pf={uniforms:{sceneDepth:{value:null},resolution:{value:new G},near:{value:.1},far:{value:1e3},viewMatrixInv:{value:new Y},projectionMatrixInv:{value:new Y},logDepth:{value:!1},ortho:{value:!1}},depthWrite:!1,depthTest:!1,vertexShader:`
    varying vec2 vUv;
    void main() {
        vUv = uv;
        gl_Position = vec4(position, 1);
        ...
        gNormal = vec4(computeNormal(
            getWorldPos(samples[chosenIndex], uvSamples[chosenIndex]), uvSamples[chosenIndex]
             ...
             uniform float frame;
                ...
                `})),this.bluenoise.colorSpace=``,this.bluenoise.wrapS=t,this.bluenoise.wrapT=t,this.bluenoise.minFilter=i,this.bluenoise.magFilter=i,this.bluenoise.needsUpdate=!0,this.lastTime=0,this.timeRollingAverage=.99,this._r=new G,this._c=new X}configureHalfResTargets(){if(this.firstFrame(),this.configuration.halfRes){this.depthDownsampleTarget=new If(this.width/2,this.height/2,2),this.depthDownsampleTarget.textures[0].format=O,this.depthDownsampleTarget.textures[0].type=g,this.depthDownsampleTarget.textures[0].minFilter=i,this.depthDownsampleTarget.textures[0].magFilter=i,this.depthDownsampleTarget.textures[0].depthBuffer=!1,this.depthDownsampleTarget.textures[1].format=T,this.depthDownsampleTarget.textures[1].type=_,this.depthDownsampleTarget.textures[1].minFilter=i,this.depthDownsampleTarget.textures[1].magFilter=i,this.depthDownsampleTarget.textures[1].depthBuffer=!1;let e={...Pf};this.configuration.depthBufferType===Rf.Reverse&&(e.fragmentShader=`#define REVERSEDEPTH
`+e.fragmentShader),this.depthDownsampleQuad=new Af(new Sa(e))}else this.depthDownsampleTarget&&=(this.depthDownsampleTarget.dispose(),null),this.depthDownsampleQuad&&=(this.depthDownsampleQuad.dispose(),null)}detectTransparency(){if(this.autoDetectTransparency){let e=!1;this.scene.traverse(t=>{t.material&&t.material.transparent&&(e=!0)}),this.configuration.transparencyAware=e}}configureTransparencyTarget(){this.configuration.transparencyAware?(this.transparencyRenderTargetDWFalse=new Kt(this.width,this.height,{minFilter:s,magFilter:i,type:_,format:T}),this.transparencyRenderTargetDWTrue=new Kt(this.width,this.height,{minFilter:s,magFilter:i,type:_,format:T}),this.transparencyRenderTargetDWTrue.depthTexture=new oa(this.width,this.height,h),this.depthCopyPass=new Af(new Sa({uniforms:{depthTexture:{value:this.depthTexture},reverseDepthBuffer:{value:this.configuration.depthBufferType===Rf.Reverse}},vertexShader:`
                        varying vec2 vUv;
                        void main() {
                            vUv = uv;
                            gl_Position = vec4(position, 1);
                        ...
                        `}))):(this.transparencyRenderTargetDWFalse&&=(this.transparencyRenderTargetDWFalse.dispose(),null),this.transparencyRenderTargetDWTrue&&=(this.transparencyRenderTargetDWTrue.dispose(),null),this.depthCopyPass&&=(this.depthCopyPass.dispose(),null))}renderTransparency(e){let t=this.scene.background,n=e.getClearColor(new X),r=e.getClearAlpha(),i=new Map,a=e.autoClearDepth;this.scene.traverse(e=>{i.set(e,e.visible)}),this.scene.background=null,e.autoClearDepth=!1,e.setClearColor(new X(0,0,0),0),this.depthCopyPass.material.uniforms.depthTexture.value=this.beautyRenderTarget.depthTexture,this.depthCopyPass.material.uniforms.reverseDepthBuffer.value=this.configuration.depthBufferType===Rf.Reverse,e.setRenderTarget(this.transparencyRenderTargetDWFalse),this.scene.traverse(e=>{e.material&&(e.visible=i.get(e)&&(e.material.transparent&&!e.material.depthWrite&&!e.userData.treatAsOpaque||!!e.userData.cannotReceiveAO))}),e.clear(!0,!0,!0),this.depthCopyPass.render(e),e.render(this.scene,this.camera),e.setRenderTarget(this.transparencyRenderTargetDWTrue),this.scene.traverse(e=>{e.material&&(e.visible=i.get(e)&&e.material.transparent&&e.material.depthWrite&&!e.userData.treatAsOpaque)}),e.clear(!0,!0,!0),this.depthCopyPass.render(e),e.render(this.scene,this.camera),this.scene.traverse(e=>{e.visible=i.get(e)}),e.setClearColor(n,r),this.scene.background=t,e.autoClearDepth=a}configureSampleDependentPasses(){this.firstFrame(),this.configureAOPass(this.configuration.depthBufferType,this.camera.isOrthographicCamera),this.configureDenoisePass(this.configuration.depthBufferType,this.camera.isOrthographicCamera)}configureAOPass(e=Rf.Default,t=!1){this.firstFrame(),this.samples=this.generateHemisphereSamples(this.configuration.aoSamples);let n={...jf};n.fragmentShader=n.fragmentShader.replace(`16`,this.configuration.aoSamples).replace(`16.0`,this.configuration.aoSamples+`.0`),e===Rf.Log?n.fragmentShader=`#define LOGDEPTH
`+n.fragmentShader:e===Rf.Reverse&&(n.fragmentShader=`#define REVERSEDEPTH
...
`+n.fragmentShader),this.effectCompositerQuad?(this.effectCompositerQuad.material.dispose(),this.effectCompositerQuad.material=new Sa(n)):this.effectCompositerQuad=new Af(new Sa(n))}generateHemisphereSamples(e){let t=[];for(let n=0;n<e;n++){let r=2.399963*n,i=Math.sqrt(n+.5)/Math.sqrt(e),a=i*Math.cos(r),o=i*Math.sin(r),s=Math.sqrt(1-(a*a+o*o));t.push(new K(a,o,s))}return t}generateDenoiseSamples(e,t){let n=2*Math.PI*t/e,r=1/e,i=r,a=[],o=r,s=0;for(let t=0;t<e;t++)a.push(new G(Math.cos(s),Math.sin(s)).multiplyScalar(o**.75)),o+=i,s+=n;return a}setSize(e,t){this.firstFrame(),this.width=e,this.height=t;let n=this.configuration.halfRes?.5:1;this.beautyRenderTarget.setSize(e,t),this.writeTargetInternal.setSize(e*n,t*n),this.readTargetInternal.setSize(e*n,t*n),this.accumulationRenderTarget.setSize(e*n,t*n),this.configuration.halfRes&&this.depthDownsampleTarget.setSize(e*n,t*n),this.configuration.transparencyAware&&(this.transparencyRenderTargetDWFalse.setSize(e,t),this.transparencyRenderTargetDWTrue.setSize(e,t))}firstFrame(){this.needsFrame=!0}render(e,t,n,r,i){(e.capabilities.logarithmicDepthBuffer&&this.configuration.depthBufferType!==Rf.Log||e.capabilities.reverseDepthBuffer&&this.configuration.depthBufferType!==Rf.Reverse)&&(this.configuration.depthBufferType=e.capabilities.logarithmicDepthBuffer?Rf.Log:e.capabilities.reverseDepthBuffer?Rf.Reverse:Rf.Default,this.configureAOPass(this.configuration.depthBufferType,this.camera.isOrthographicCamera),this.configureDenoisePass(this.configuration.depthBufferType,this.camera.isOrthographicCamera),this.configureEffectCompositer(this.configuration.depthBufferType,this.camera.isOrthographicCamera)),this.detectTransparency(),this.camera.updateMatrixWorld(),this.lastViewMatrix.equals(this.camera.matrixWorldInverse)&&this.lastProjectionMatrix.equals(this.camera.projectionMatrix)&&this.configuration.accumulate&&!this.needsFrame?this.frame++:(this.configuration.accumulate&&(e.setRenderTarget(this.accumulationRenderTarget),e.clear(!0,!0,!0)),this.frame=0,this.needsFrame=!1),this.lastViewMatrix.copy(this.camera.matrixWorldInverse),this.lastProjectionMatrix.copy(this.camera.projectionMatrix);let a,o,s;this.debugMode&&(a=e.getContext(),o=a.getExtension(`EXT_disjoint_timer_query_webgl2`),o===null&&(console.error(`EXT_disjoint_timer_query_webgl2 not available, disabling debug mode.`),this.debugMode=!1)),this.configuration.autoRenderBeauty&&(e.setRenderTarget(this.beautyRenderTarget),e.render(this.scene,this.camera),this.configuration.transparencyAware&&this.renderTransparency(e)),this.debugMode&&(s=a.createQuery(),a.beginQuery(o.TIME_ELAPSED_EXT,s));let c=e.xr.enabled;e.xr.enabled=!1,this._r.set(this.width,this.height);let l=this.configuration.aoRadius;if(this.configuration.halfRes&&this.configuration.screenSpaceRadius&&(l*=.5),this.frame<1024/this.configuration.aoSamples){this.configuration.halfRes&&(e.setRenderTarget(this.depthDownsampleTarget),this.depthDownsampleQuad.material.uniforms.sceneDepth.value=this.beautyRenderTarget.depthTexture,this.depthDownsampleQuad.material.uniforms.resolution.value=this._r,this.depthDownsampleQuad.material.uniforms.near.value=this.camera.near,this.depthDownsampleQuad.material.uniforms.far.value=this.camera.far,this.depthDownsampleQuad.material.uniforms.projectionMatrixInv.value=this.camera.projectionMatrixInverse,this.depthDownsampleQuad.material.uniforms.viewMatrixInv.value=this.camera.matrixWorld,this.depthDownsampleQuad.material.uniforms.logDepth.value=this.configuration.depthBufferType===Rf.Log,this.depthDownsampleQuad.material.uniforms.ortho.value=this.camera.isOrthographicCamera,this.depthDownsampleQuad.render(e)),this.effectShaderQuad.material.uniforms.sceneDiffuse.value=this.beautyRenderTarget.texture,this.effectShaderQuad.material.uniforms.sceneDepth.value=this.configuration.halfRes?this.depthDownsampleTarget.textures[0]:this.beautyRenderTarget.depthTexture,this.effectShaderQuad.material.uniforms.sceneNormal.value=this.configuration.halfRes?this.depthDownsampleTarget.textures[1]:null,this.effectShaderQuad.material.uniforms.projMat.value=this.camera.projectionMatrix,this.effectShaderQuad.material.uniforms.viewMat.value=this.camera.matrixWorldInverse,this.effectShaderQuad.material.uniforms.projViewMat.value=this.camera.projectionMatrix.clone().multiply(this.camera.matrixWorldInverse.clone()),this.effectShaderQuad.material.uniforms.projectionMatrixInv.value=this.camera.projectionMatrixInverse,this.effectShaderQuad.material.uniforms.viewMatrixInv.value=this.camera.matrixWorld,this.effectShaderQuad.material.uniforms.cameraPos.value=this.camera.getWorldPosition(new K),this.effectShaderQuad.material.uniforms.biasAdjustment.value=new G(this.configuration.biasOffset,this.configuration.biasMultiplier),this.effectShaderQuad.material.uniforms.resolution.value=this.configuration.halfRes?this._r.clone().multiplyScalar(.5).floor():this._r,this.effectShaderQuad.material.uniforms.time.value=performance.now()/1e3,this.effectShaderQuad.material.uniforms.samples.value=this.samples,this.effectShaderQuad.material.uniforms.bluenoise.value=this.bluenoise,this.effectShaderQuad.material.uniforms.radius.value=l,this.effectShaderQuad.material.uniforms.distanceFalloff.value=this.configuration.distanceFalloff,this.effectShaderQuad.material.uniforms.near.value=this.camera.near,this.effectShaderQuad.material.uniforms.far.value=this.camera.far,this.effectShaderQuad.material.uniforms.ortho.value=this.camera.isOrthographicCamera,this.effectShaderQuad.material.uniforms.screenSpaceRadius.value=this.configuration.screenSpaceRadius,this.effectShaderQuad.material.uniforms.frame.value=this.frame,e.setRenderTarget(this.writeTargetInternal),this.effectShaderQuad.render(e);for(let t=0;t<this.configuration.denoiseIterations;t++)[this.writeTargetInternal,this.readTargetInternal]=[this.readTargetInternal,this.writeTargetInternal],this.poissonBlurQuad.material.uniforms.tDiffuse.value=this.readTargetInternal.texture,this.poissonBlurQuad.material.uniforms.sceneDepth.value=this.configuration.halfRes?this.depthDownsampleTarget.textures[0]:this.beautyRenderTarget.depthTexture,this.poissonBlurQuad.material.uniforms.projMat.value=this.camera.projectionMatrix,this.poissonBlurQuad.material.uniforms.viewMat.value=this.camera.matrixWorldInverse,this.poissonBlurQuad.material.uniforms.projectionMatrixInv.value=this.camera.projectionMatrixInverse,this.poissonBlurQuad.material.uniforms.viewMatrixInv.value=this.camera.matrixWorld,this.poissonBlurQuad.material.uniforms.cameraPos.value=this.camera.getWorldPosition(new K),this.poissonBlurQuad.material.uniforms.resolution.value=this.configuration.halfRes?this._r.clone().multiplyScalar(.5).floor():this._r,this.poissonBlurQuad.material.uniforms.time.value=performance.now()/1e3,this.poissonBlurQuad.material.uniforms.blueNoise.value=this.bluenoise,this.poissonBlurQuad.material.uniforms.radius.value=this.configuration.denoiseRadius*(this.configuration.halfRes?.5:1),this.poissonBlurQuad.material.uniforms.worldRadius.value=l,this.poissonBlurQuad.material.uniforms.distanceFalloff.value=this.configuration.distanceFalloff,this.poissonBlurQuad.material.uniforms.index.value=t,this.poissonBlurQuad.material.uniforms.poissonDisk.value=this.samplesDenoise,this.poissonBlurQuad.material.uniforms.near.value=this.camera.near,this.poissonBlurQuad.material.uniforms.far.value=this.camera.far,this.poissonBlurQuad.material.uniforms.screenSpaceRadius.value=this.configuration.screenSpaceRadius,e.setRenderTarget(this.writeTargetInternal),this.poissonBlurQuad.render(e);e.setRenderTarget(this.accumulationRenderTarget);let t=e.autoClear;e.autoClear=!1,this.accumulationQuad.material.uniforms.tDiffuse.value=this.writeTargetInternal.texture,this.accumulationQuad.material.uniforms.frame.value=this.frame,this.accumulationQuad.render(e),e.autoClear=t}this.configuration.transparencyAware&&(this.effectCompositerQuad.material.uniforms.transparencyDWFalse.value=this.transparencyRenderTargetDWFalse.texture,this.effectCompositerQuad.material.uniforms.transparencyDWTrue.value=this.transparencyRenderTargetDWTrue.texture,this.effectCompositerQuad.material.uniforms.transparencyDWTrueDepth.value=this.transparencyRenderTargetDWTrue.depthTexture,this.effectCompositerQuad.material.uniforms.transparencyAware.value=!0),this.effectCompositerQuad.material.uniforms.sceneDiffuse.value=this.beautyRenderTarget.texture,this.effectCompositerQuad.material.uniforms.sceneDepth.value=this.beautyRenderTarget.depthTexture,this.effectCompositerQuad.material.uniforms.aoTones.value=this.configuration.aoTones,this.effectCompositerQuad.material.uniforms.near.value=this.camera.near,this.effectCompositerQuad.material.uniforms.far.value=this.camera.far,this.effectCompositerQuad.material.uniforms.projectionMatrixInv.value=this.camera.projectionMatrixInverse,this.effectCompositerQuad.material.uniforms.viewMatrixInv.value=this.camera.matrixWorld,this.effectCompositerQuad.material.uniforms.ortho.value=this.camera.isOrthographicCamera,this.effectCompositerQuad.material.uniforms.downsampledDepth.value=this.configuration.halfRes?this.depthDownsampleTarget.textures[0]:this.beautyRenderTarget.depthTexture,this.effectCompositerQuad.material.uniforms.resolution.value=this._r,this.effectCompositerQuad.material.uniforms.blueNoise.value=this.bluenoise,this.effectCompositerQuad.material.uniforms.intensity.value=this.configuration.intensity,this.effectCompositerQuad.material.uniforms.renderMode.value=this.configuration.renderMode,this.effectCompositerQuad.material.uniforms.screenSpaceRadius.value=this.configuration.screenSpaceRadius,this.effectCompositerQuad.material.uniforms.radius.value=l,this.effectCompositerQuad.material.uniforms.distanceFalloff.value=this.configuration.distanceFalloff,this.effectCompositerQuad.material.uniforms.gammaCorrection.value=this.configuration.gammaCorrection,this.effectCompositerQuad.material.uniforms.tDiffuse.value=this.accumulationRenderTarget.texture,this.effectCompositerQuad.material.uniforms.color.value=this._c.copy(this.configuration.color).convertSRGBToLinear(),this.effectCompositerQuad.material.uniforms.colorMultiply.value=this.configuration.colorMultiply,this.effectCompositerQuad.material.uniforms.cameraPos.value=this.camera.getWorldPosition(new K),this.effectCompositerQuad.material.uniforms.fog.value=!!this.scene.fog,this.scene.fog&&(this.scene.fog.isFog?(this.effectCompositerQuad.material.uniforms.fogExp.value=!1,this.effectCompositerQuad.material.uniforms.fogNear.value=this.scene.fog.near,this.effectCompositerQuad.material.uniforms.fogFar.value=this.scene.fog.far):this.scene.fog.isFogExp2?(this.effectCompositerQuad.material.uniforms.fogExp.value=!0,this.effectCompositerQuad.material.uniforms.fogDensity.value=this.scene.fog.density):console.error(`Unsupported fog type ${this.scene.fog.constructor.name} in SSAOPass.`)),e.setRenderTarget(this.renderToScreen?null:t),this.effectCompositerQuad.render(e),this.debugMode&&(a.endQuery(o.TIME_ELAPSED_EXT),Lf(s,a,this)),e.xr.enabled=c}enableDebugMode(){this.debugMode=!0}disableDebugMode(){this.debugMode=!1}setDisplayMode(e){this.configuration.renderMode=[`Combined`,`AO`,`No AO`,`Split`,`Split AO`].indexOf(e)}setQualityMode(e){e===`Performance`?(this.configuration.aoSamples=8,this.configuration.denoiseSamples=4,this.configuration.denoiseRadius=12):e===`Low`?(this.configuration.aoSamples=16,this.configuration.denoiseSamples=4,this.configuration.denoiseRadius=12):e===`Medium`?(this.configuration.aoSamples=16,this.configuration.denoiseSamples=8,this.configuration.denoiseRadius=12):e===`High`?(this.configuration.aoSamples=64,this.configuration.denoiseSamples=8,this.configuration.denoiseRadius=6):e===`Ultra`&&(this.configuration.aoSamples=64,this.configuration.denoiseSamples=16,this.configuration.denoiseRadius=6)}},Bf={uniforms:{tDiffuse:{value:null},uTime:{value:0},uSaturation:{value:1.06},uWarmth:{value:.035},uContrast:{value:1.04},uLift:{value:.01},uVignette:{value:.26},uGrain:{value:.012}},vertexShader:`
    ...
    }`};function Vf(e,t,n){let r=e.getSize(new G),i=e.getPixelRatio(),a=Math.floor(r.x*i),o=Math.floor(r.y*i),s=new bf(e,new Kt(a,o,{type:_})),c=new URLSearchParams(location.search),l=new zf(t,n,a,o);l.configuration.aoRadius=1.6,l.configuration.distanceFalloff=4,l.configuration.intensity=c.get(`aoint`)?parseFloat(c.get(`aoint`)):1.4,l.configuration.halfRes=!0,l.configuration.depthAwareUpsampling=!0,l.configuration.gammaCorrection=!1,c.has(`noao`)?s.addPass(new xf(t,n)):s.addPass(l),s.addPass(new Cf);let u=new _f(Bf);s.addPass(u);let d=new Df;return s.addPass(d),{composer:s,grade:u,n8ao:l,setSize(e,t){s.setSize(e,t)},render(e){u.uniforms.uTime.value=e,s.render()}}}var Hf=[{name:`campsite-closeup`,pos:[-2.4,-3.4],eye:1.5,target:[1.5,.75,1]},{name:`grass-eye-level`,pos:[-13,9],eye:.7,target:[-4,1.3,19]},{name:`hero-tree-lookup`,pos:[-3.5,-.5],eye:1.6,target:[-8.5,7,-6.5]},{name:`wide-vista`,pos:[-7,9],eye:1.7,target:[17.3,2.6,26.7]},{name:`backlit-camp`,pos:[-3,-13],eye:1.55,target:[1.5,1.2,1]},{name:`ground-detail`,pos:[3.4,3.6],eye:1.45,target:[1.2,.3,.8]}];function Uf(){return new URLSearchParams(location.search).has(`shot`)}function Wf({camera:e,renderer:t,getTerrainHeight:n,requestFrames:r}){let i=!1;return window.__READY=!1,window.__views=()=>Hf.map(e=>e.name),window.__setView=async t=>{let i=new URLSearchParams(location.search).get(`topdown`);if(i){let a=parseFloat(i)||40;return e.position.set(1.5,n(1.5,1)+a,1),e.lookAt(1.6,0,1),e.updateMatrixWorld(),await r(4),`topdown${t}`}let a=Hf[t];if(!a)throw Error(`no viewpoint ${t}`);let[o,s]=a.pos,c=n(o,s)+a.eye;return e.position.set(o,c,s),e.lookAt(a.target[0],a.target[1],a.target[2]),e.updateMatrixWorld(),await r(4),a.name},window.__stats=()=>({calls:t.info.render.calls,triangles:t.info.render.triangles,geometries:t.info.memory.geometries,textures:t.info.memory.textures,programs:t.info.programs?t.info.programs.length:0}),{async markReady(){i||(i=!0,await r(8),window.__READY=!0)}}}var Gf=document.getElementById(`app`),Kf=document.getElementById(`overlay`),qf=document.getElementById(`loading`),Jf=Uf(),Yf=new URLSearchParams(location.search),Xf=Yf.get(`px`)?parseFloat(Yf.get(`px`)):null,Zf=new uu({antialias:!0,powerPreference:`high-performance`});Zf.setSize(window.innerWidth,window.innerHeight),Zf.setPixelRatio(Xf??Math.min(window.devicePixelRatio,2)),Zf.outputColorSpace=Re,Zf.toneMapping=4,Zf.toneMappingExposure=.7,Zf.shadowMap.enabled=!0,Zf.shadowMap.type=1,Zf.info.autoReset=!1,Gf.appendChild(Zf.domElement);var Qf=new Mn,$f=new vo(55,window.innerWidth/window.innerHeight,.1,800),ep=new vu($f,Zf.domElement),tp=[];function np(e){return new Promise(t=>tp.push({n:e,resolve:t}))}var rp=await df(Qf,Zf,e=>{qf.textContent=`Loading the wilderness… ${Math.round(e*100)}%`});ep.getTerrainHeight=rp.getTerrainHeight,ep.colliders=rp.colliders,ep.setPose(8,10,Math.PI*.85,-.05);var ip=Wf({camera:$f,renderer:Zf,getTerrainHeight:rp.getTerrainHeight,requestFrames:np});if(Yf.has(`nogeo`)&&Qf.traverse(e=>{e.isMesh&&(e.visible=!1)}),Yf.has(`nograss`)){let e=Qf.getObjectByName(`grass`);e&&(e.visible=!1)}if(Yf.has(`noveg`)){let e=Qf.getObjectByName(`vegetation`);e&&(e.visible=!1)}if(Yf.has(`pole`)){let e=new ri(new la(.4,12,.4),new wa({color:16777215,roughness:.9}));e.castShadow=!0,e.position.set(1.5,rp.getTerrainHeight(1.5,1)+6,1),Qf.add(e)}Yf.has(`noenv`)&&(Qf.environment=null);{let e=rp.sky?.sun;window.__dbg={shadowMapEnabled:Zf.shadowMap.enabled,shadowMapType:Zf.shadowMap.type,sunCastShadow:e?.castShadow,sunIntensity:e?.intensity,envIntensity:Qf.environmentIntensity,sunPos:e?.position.toArray().map(e=>Math.round(e)),camLeft:e?.shadow.camera.left,camProj0:e?.shadow.camera.projectionMatrix.elements[0],exposure:Zf.toneMappingExposure,fogDensity:Qf.fog?.density,hasEnv:!!Qf.environment,lightCount:(()=>{let e=0;return Qf.traverse(t=>t.isLight&&e++),e})()}}Yf.get(`exp`)&&(Zf.toneMappingExposure=parseFloat(Yf.get(`exp`)));var ap=Yf.has(`nopost`)?null:Vf(Zf,Qf,$f);qf.classList.add(`hidden`),Jf?(ep.enabled=!1,Kf.classList.add(`hidden`)):(Kf.classList.remove(`hidden`),Kf.addEventListener(`click`,()=>ep.lock()),ep.onLockChange=e=>Kf.classList.toggle(`hidden`,e)),window.addEventListener(`resize`,()=>{$f.aspect=window.innerWidth/window.innerHeight,$f.updateProjectionMatrix(),Zf.setSize(window.innerWidth,window.innerHeight),ap&&ap.setSize(window.innerWidth,window.innerHeight)});var op=performance.now(),sp=0;function cp(){Zf.info.reset();let e=performance.now(),t=Math.min((e-op)/1e3,.05);op=e,sp+=t,Jf||ep.update(t);let n=Jf?42:sp;if(rp.update(n,t,$f),ap?ap.render(n):Zf.render(Qf,$f),tp.length){for(let e of tp)--e.n;let e=tp.filter(e=>e.n<=0);tp=tp.filter(e=>e.n>0);for(let t of e)t.resolve()}}Zf.setAnimationLoop(cp),ip.markReady(),window.__scene=Qf,window.__camera=$f,Jf||(window.__controls=ep),console.log(`[camp] boot ok — shotMode=${Jf}, views=${Hf.length}`);